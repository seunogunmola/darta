                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="{{ route('products.edit',$order->id) }}">Edit</a></li>
                                            <li><a class="dropdown-item" href="{{ route('retailer.orders.details',$order->uniqueid) }}">View Details</a></li>
