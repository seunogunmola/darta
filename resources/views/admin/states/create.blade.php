                    ...
                    <div class="border p-4 rounded">
                        ...
                        <form action="{{ route('states.store') }}" method="post">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input name="state_name" required value="{{ old('state_name') }}" type="text" class="form-control" id="state_name" placeholder="Enter State Name">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="inputEnterYourName" class="col-sm-3 col-form-label">State Abbreviation</label>
                                <div class="col-sm-9">
                                    <input name="state_abbreviation" required value="{{ old('state_abbreviation') }}" type="text" class="form-control" id="state_abbreviation" placeholder="Enter State Abbreviation">
                                </div>
                            </div>
                            <div class="row mb-3">
