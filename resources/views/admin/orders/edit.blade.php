                    ...
                    <div class="border p-4 rounded">
                        ...
                        <form action="{{ route('products.update',$product->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input name="sku" required value="{{ old('sku',$product->sku) }}"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input name="product_name" required value="{{ old('product_name',$product->product_name) }}" type="text"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="product_description" class="form-control" id="" cols="30" rows="5" placeholder="Enter Product Description">{{ old('product_description',$product->product_description) }}</textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="inputEnterYourName" class="col-sm-3 col-form-label">Product Price</label>
                                <div class="col-sm-9">
                                    <input name="product_price" required value="{{ old('product_price',$product->product_price) }}" type="number"
                                ...
                                <div class="col-sm-9">
                                    <select name="unit_id" id="unit_id" required class="form-select">
                                        ...
                                        @foreach($units as $unit)
                                            <option {{ $product->unit_id == $unit->id ?  "selected" : "" }}  value="{{ old('unit_id',$unit->id) }}">{{ $unit->unit_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>                                                    
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <img style="width:150px;" src="{{ !empty($product->product_image) ? asset($product->product_image) : asset('assets/noimage.jpg') }}" alt="">
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select name="distributor_id" id="distributor_id" required class="form-select">
                                        ...
                                        @foreach($distributors as $distributor)
                                            <option {{ $product->distributor_id == $distributor->id ?  "selected" : "" }}  value="{{ old('distributor_id',$distributor->id) }}">{{ $distributor->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select name="status" id="status" required class="form-control">
                                        <option value="">Select Option</option>
                                        <option {{ $product->status == 1 ?  "selected" : "" }} value="1">Enabled</option>
                                        <option {{ $product->status  == 0 ?  "selected" : "" }} value="0">Disabled</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
